            ...
            <div className="flex items-center gap-4">
              ...
              >
                <div className="w-6 h-6 flex flex-col justify-center gap-1.5">
                  <span
                    className={`block w-6 h-0.5 bg-black dark:bg-gray-300 transition-all duration-300 ${isMenuOpen ? "rotate-45 translate-y-2" : ""
                      }`}
                  />
                  <span
                    className={`block w-6 h-0.5 bg-black dark:bg-gray-300 transition-all duration-300 ${isMenuOpen ? "opacity-0" : ""
                      }`}
                  />
                  <span
                    className={`block w-6 h-0.5 bg-black dark:bg-gray-300 transition-all duration-300 ${isMenuOpen ? "-rotate-45 -translate-y-2" : ""
                ...
                <div className="p-6 border-t border-purple-500/10 dark:border-purple-500/5">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-400">
                      © {new Date().getFullYear()} Ezhar Ahmad
                    </span>
                    <motion.button
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.9 }}
