          ...
          >
            ...
            >
              <div className="flex -space-x-3">
                {[
                  { id: 1, image: "/Images/legacylogix.png" },
                  { id: 2, image: "/Images/xtel.png" },
                  { id: 3, image: "/Images/cloudsyte.png" },
                  { id: 4, image: "/Images/job-tracker.png" },
                ].map((i) => (
                  <div
                    key={i.id}
                    className="w-10 h-10 rounded-full border-2 border-purple-500/20 dark:border-purple-500/30 bg-purple-500/5 dark:bg-purple-900/30 overflow-hidden"
                  >
                    <Image
                      src={i.image}
                      alt="Project"
